...
df1 = pd.read_csv(r'/Users/noor/taktiles-internet-aip/data/sc2_data_person1_preprocessed.csv')
df2 = pd.read_csv(r'/Users/noor/taktiles-internet-aip/data/sc2_data_person2_preprocessed.csv')
dfcam = pd.read_csv(r'/Users/noor/taktiles-internet-aip/data/sc2_data_person2_optitrackprocessed.csv')
...
action_cam = df2.iloc[237:278,7]                     # Z-Pos
...
plt.title('Speaker 2 Moving Sideways Comparison')
plt.legend()
plt.show()
